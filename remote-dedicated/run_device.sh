...
#   Run small Lumerical DEVICE job on a Linux machine, to be used with remote dispatch
#   Input: ldev file with DEVICE simulation
#   Set REFRESH=1 to refresh/regenerate ldev file before execution; useful when working with disparate versions
...
THREADS=16  # Default
CAD="/opt/lumerical/v222/bin/device-app"
ENG="/opt/lumerical/v222/bin/device-engine-mpich2nem"
...
# Possibly refresh/regenerate the ldev file
[[ "$REFRESH" -eq 1 ]] && {
